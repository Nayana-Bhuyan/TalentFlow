            ...
            <div className="font-sans w-full mt-16   bg-gray-50 min-h-screen">
                ...
                <div className="p x-8 px-5 py-6 bg-white border-b border-gray-200">
                    ...
                    <div className="flex gap-4">
                        ...
                        <div onClick={()=>{setjobTitle("");setexperience("");setskill("");setlacation("");setsalary("")}} className='py-0.5 px-1 '>
                        ...
                        <select value={jobTitle} onChange={e => setjobTitle(e.target.value)} className="px-4 py-2 border w-32  border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">
                            <option value={""}>Job Title</option>
                            {filterOption.jobTitle.map(el => <option value={el}>{el}</option>)}
                        </select>
                        <select value={experience} onChange={e => setexperience(e.target.value)} className="px-4 py-2 w-32  border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">
                        ...
                        <select value={skill} onChange={e => setskill(e.target.value)} className="px-4 py-2 w-32  border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">
                            <option value={""}>Skills</option>
                            {filterOption.skills.map(el => <option value={el}>{el}</option>)}
                        </select>
                        <select value={lacation} onChange={e => setlacation(e.target.value)} className="px-4 py-2 w-32  border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">
                            <option value={""}>Location</option>
                            {filterOption.location.map(el => <option value={el}>{el}</option>)}
                        </select>
                        <select value={salary} onChange={e => setsalary(e.target.value)} className="px-4 py-2 w-32  border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">
                    ...
                    {candidates.map(candidate => (
                        <div className="border border-gray-200 p-6 mb-4 rounded-lg flex items-start bg-white shadow-sm hover:shadow-md transition-shadow">
                            ...
                            <div className="flex-1 min-w-0">
                                ...
                                <h6 style={{ color: "#4B5563" }} className='mb-1 font-normal text-base '>{candidate.job}</h6>
